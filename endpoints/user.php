<?php
    ...
    function UserReadById($requestObject, $params){
        ...
        try {
            ...
            //SQL query to select users
            $query = "SELECT `id`, `username`, `email`, `password`, `is_manager`, `is_admin`, `is_active`, `is_deleted` FROM user WHERE `id`= :id AND `is_deleted`= :is_deleted";
    ...
    function UserUpdate($requestObject, $params){
        ...
        try {
            ...
            //SQL query to select users
            $query = "UPDATE user SET `username`=:username, `email`=:email, `password`=:password, `is_manager`=:is_manager, `is_admin`=:is_admin, `is_active`=:is_active, `is_deleted`=:is_deleted WHERE `id`= :id";
